export default function Tarjeta({ titulo, Contenido }) {
  return (
    <section className="grid bg-white shadow-lg max-w-md w-full m-4 rounded-xl overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl">
